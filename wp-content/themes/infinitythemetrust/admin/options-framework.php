...
/* Loads the file for additional customizer field types */
if ( class_exists( 'WP_Customize_Control' ) ) {
	add_action('init', 'optionsframework_load_customizer_options' );
}

function optionsframework_load_customizer_options() {
