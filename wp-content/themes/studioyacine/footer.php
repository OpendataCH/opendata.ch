	<footer class="Footer" role="contentinfo" itemscope itemtype="http://schema.org/WPFooter">
		...
		<div class="Footer--bottom">
			<a class='Footer--okfn' target="_blank" href="https://okfn.org/en/switzerland/"><img src="<?php echo get_template_directory_uri(); ?>/library/img/OK-notext-black.png" alt="Open Knowledge Foundation"></a>
