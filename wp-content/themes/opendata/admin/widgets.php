...
?>				
			...
			<ul class="widgetList">
				...
				<li class="clearfix">
					...
					<?php endif; ?>
					<span class="title"><a href="<?php the_permalink() ?>" title="<?php echo esc_attr(get_the_title() ? get_the_title() : get_the_ID()); ?>"><?php if ( get_the_title() ) the_title(); else the_ID(); ?> </a></span>
